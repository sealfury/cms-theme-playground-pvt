...
var parentMenuItems = document.querySelectorAll('.top-menu--desktop .top-menu__item--has-submenu');
var menuChildToggle = document.querySelectorAll('.top-menu--mobile .top-menu__child-toggle');

if (parentMenuItems) {
  parentMenuItems.forEach(function (item) {
    var menuChildToggle = item.querySelector('.top-menu__child-toggle');
    // TODO: add focus on siblings on mouseover (hover effect on both)
